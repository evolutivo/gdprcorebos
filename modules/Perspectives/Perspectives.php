...
class Perspectives extends CRMEntity {
	...
	public $table_name = 'vtiger_perspectives';
	public $table_index= 'perspectivesid';
	 ...
	 */
	public $customFieldTable = array('vtiger_perspectivescf', 'perspectivesid');
	 ...
	 */
	public $tab_name = array('vtiger_crmentity', 'vtiger_perspectives', 'vtiger_perspectivescf');
	...
	public $list_link_field = 'perspective_name';
	...
	public $popup_fields = Array('perspective_name');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	public $sortby_fields = array();

	// For Alphabetical search
	public $def_basicsearch_col = 'perspective_name';

	// Column value to use on detail view record text display
	public $def_detailview_recname = 'perspective_name';

	// Required Information for enabling Import feature
	public $required_fields = array('perspective_name'=>1);

	// Callback function list during Importing
	public $special_functions = array('set_import_assigned_user');

	public $default_order_by = 'perspective_name';
	public $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	public $mandatory_fields = array('createdtime', 'modifiedtime','perspective_name', 'perspective_file');
