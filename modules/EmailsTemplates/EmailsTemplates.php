...
class EmailsTemplates extends CRMEntity {
	public $db;
	public $log;
...
public $column_fields = array();
	 ...
	 */
	public $customFieldTable = array('vtiger_emailstemplatescf', 'emailstemplatesid');
	 ...
	 */
	public $tab_name = array('vtiger_crmentity', 'vtiger_emailstemplates', 'vtiger_emailstemplatescf');
	...
	public $tab_name_index = array(
		...
		'vtiger_emailstemplates'   => 'emailstemplatesid',
		'vtiger_emailstemplatescf' => 'emailstemplatesid',
	);
	...
	public $popup_fields = array('emailstemplatesno');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	public $sortby_fields = array();

	// For Alphabetical search
	public $def_basicsearch_col = 'emailstemplatesno';

	// Column value to use on detail view record text display
	public $def_detailview_recname = 'emailstemplatesno';
	...
	public $default_order_by = 'emailstemplatesno';
