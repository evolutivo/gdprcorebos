...
class Tariffs extends CRMEntity {
	public $db;
	public $log;
	...
	public $list_fields = array(
		...
		'Tariff Name'=> array('tariffs'=> 'tariffsname'),
        	'Prodotto'=>Array('tariffs'=>'product')
);
	public $list_fields_name = array(
		/* Format: Field Label => fieldname */
		'Tariff Name'=> 'tariffsname',
        	'Prodotto'=>'product'
	);

	// Make the field link to detail view from list view (Fieldname)
	public $list_link_field = 'tariffsname';
	...
	public $popup_fields = array('tariffsname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	public $sortby_fields = array();

	// For Alphabetical search
	public $def_basicsearch_col = 'tariffsname';

	// Column value to use on detail view record text display
	public $def_detailview_recname = 'tariffsname';

	// Required Information for enabling Import feature
	public $required_fields = array('tariffsname'=>1);

	// Callback function list during Importing
	public $special_functions = array('set_import_assigned_user');

	public $default_order_by = 'tariffsname';
	public $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	public $mandatory_fields = array('createdtime', 'modifiedtime', 'tariffsname');
