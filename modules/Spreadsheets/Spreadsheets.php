...
class Spreadsheets extends CRMEntity {
	...
	public $table_name = 'vtiger_spreadsheets';
	public $table_index= 'spreadsheetsid';
	 ...
	 */
	public $customFieldTable = array('vtiger_spreadsheetscf', 'spreadsheetsid');
	 ...
	 */
	public $tab_name = array('vtiger_crmentity', 'vtiger_spreadsheets', 'vtiger_spreadsheetscf');
	...
	public $list_link_field = 'spreadsheetsname';
	...
	public $popup_fields = array('spreadsheetsname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	public $sortby_fields = array();

	// For Alphabetical search
	public $def_basicsearch_col = 'spreadsheetsname';

	// Column value to use on detail view record text display
	public $def_detailview_recname = 'spreadsheetsname';

	// Required Information for enabling Import feature
	public $required_fields = array('spreadsheetsname'=>1);

	// Callback function list during Importing
	public $special_functions = array('set_import_assigned_user');

	public $default_order_by = 'spreadsheetsname';
	public $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	public $mandatory_fields = array('createdtime', 'modifiedtime', 'spreadsheetsname');
