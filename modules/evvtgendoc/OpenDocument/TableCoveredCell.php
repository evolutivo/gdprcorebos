<?php
/**
* OpenDocument_TableCoveredCell class
*
...
/**
* OpenDocument_TableCoveredCell element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_TableCoveredCell extends OpenDocument_StyledElement
{
    /**
     ...
     */
    public static function instance($object, $colspan='')
    {
