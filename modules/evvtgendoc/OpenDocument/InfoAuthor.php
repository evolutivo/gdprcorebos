...
/**
* OpenDocument_InfoAuthor element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_InfoAuthor extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
     ...
     * @param mixed $object
     * @param mixed $content
     * @return OpenDocument_InfoAuthor
