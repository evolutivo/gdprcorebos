<?php
/**
* OpenDocument_DrawEGeometry class
*
...
/**
* OpenDocument_DrawEGeometry element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_DrawEGeometry extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
     ...
     * Node name
     */
    const nodeName = 'enhanced-geometry';
    ...
    public function __construct(DOMNode $node, OpenDocument $document)
    {
        ...
        $this->allowedElements = array(
            'OpenDocument_DrawHandle',
            'OpenDocument_DrawEquation',
        );
    }
     ...
     * @param mixed $object
     * @param mixed $content
     * @return OpenDocument_DrawEGeometry
    ...
    public static function instance($object)
    {
        ...
        $element = new OpenDocument_DrawEGeometry($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document);
    ...
    public function createDrawEquation()
    {
        return OpenDocument_DrawEquation::instance($this);
    }
    public function createDrawHandle()
    {
        return OpenDocument_DrawHandle::instance($this);
    }
}
?>
