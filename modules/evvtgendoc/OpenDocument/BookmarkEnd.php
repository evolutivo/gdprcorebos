<?php
/**
* OpenDocument_BookmarkEnd class
*
...
/**
* OpenDocument_BookmarkEnd element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_BookmarkEnd extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
     ...
     * Node name
     */
    const nodeName = 'bookmark-end';
    
    /**
     * Element style name prefix
     */
    const styleNamePrefix = 'bme';
     ...
     * @param mixed $object
     * @param mixed $content
     * @return OpenDocument_BookmarkEnd
    ...
    public static function instance($object, $content)
    {
        ...
        $element = new OpenDocument_BookmarkEnd($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document, $content);
