<?php
/**
* OpenDocument_NoteCitation class
*
...
/**
* OpenDocument_NoteCitation element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_NoteCitation extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
     ...
     */
    public static function instance($object, $content, $sel='')
    {
        ...
        $element = new OpenDocument_NoteCitation($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document, $content, $sel);
