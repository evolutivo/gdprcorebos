<?php
/**
* OpenDocument_TextLineBreak class
*
...
/**
* OpenDocument_TextLineBreak element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_TextLineBreak extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
     ...
     * Node name
     */
    const nodeName = 'line-break';
    
    /**
     * Element style name prefix
     */
    const styleNamePrefix = 'LB';
     ...
     * @param mixed $object
     * @param mixed $content
     * @return OpenDocument_TextLineBreak
    ...
    public static function instance($object)
    {
        ...
        $element = new OpenDocument_TextLineBreak($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document);
