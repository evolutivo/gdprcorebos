<?php
/**
* OpenDocument_BookmarkStart class
*
...
/**
* OpenDocument_BookmarkStart element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_BookmarkStart extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
     ...
     * Node name
     */
    const nodeName = 'bookmark-start';
    
    /**
     * Element style name prefix
     */
    const styleNamePrefix = 'bms';
     ...
     * @param mixed $object
     * @param mixed $content
     * @return OpenDocument_BookmarkStart
    ...
    public static function instance($object, $content)
    {
        ...
        $element = new OpenDocument_BookmarkStart($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document, $content);
