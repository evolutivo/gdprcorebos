...
/**
* OpenDocument_InfoTitle element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_InfoTitle extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
    ...
    public static function instance($object, $content)
    {
        ...
        $element = new OpenDocument_InfoTitle($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document, $content);
