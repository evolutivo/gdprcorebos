...
/**
* OpenDocument_PageCount element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_PageCount extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
    ...
    public static function instance($object, $content)
    {
        ...
        $element = new OpenDocument_PageCount($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document, $content);
