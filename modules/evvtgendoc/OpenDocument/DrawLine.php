...
*/
class OpenDocument_DrawLine extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
    ...
    public static function instance($object)
    {
        ...
        $element = new OpenDocument_DrawLine($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document);
