...
/**
* OpenDocument_PageNumber element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_PageNumber extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
     ...
     * @param mixed $object
     * @param mixed $content
     * @return OpenDocument_PageNumber
