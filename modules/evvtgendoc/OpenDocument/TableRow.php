...
*/
class OpenDocument_TableRow extends OpenDocument_StyledElement
{
    /**
    ...
    public static function instance($object)
    {
        ...
        $element = new OpenDocument_TableRow($node->ownerDocument->createElementNS(self::nodeNS, self::nodeName), $document);
