<?php
/**
* OpenDocument_DrawConnector class
*
...
/**
* OpenDocument_DrawConnector element
*
* @category   File Formats
* @package    OpenDocument
...
*/
class OpenDocument_DrawConnector extends OpenDocument_StyledElement
{
    /**
     * Node namespace
     */
     ...
     * @param mixed $object
     * @param mixed $content
     * @return OpenDocument_DrawConnector
