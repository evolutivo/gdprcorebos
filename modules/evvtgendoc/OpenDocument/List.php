...
*/
class OpenDocument_List extends OpenDocument_StyledElement
{
    /**
     ...
     */
    public function __construct(DOMNode $node, OpenDocument $document, $contnum='')
    {
        parent::__construct($node, $document);
        $continuenum = $node->getAttributeNS(OpenDocument::NS_TEXT, 'continue-numbering');
        if (empty($continuenum)) $continuenum=$contnum;
        if (!empty($continuenum)) {
          $this->node->setAttributeNS(OpenDocument::NS_TEXT, 'continue-numbering', $continuenum);
     ...
     * @param mixed $object
     * @param mixed $content
     * @return OpenDocument_List
     * @throws OpenDocument_Exception
     */
    public static function instance($object, $contnum='')
    {
    ...
    /**
     * Create OpenDocument_ListItem
     *
     * @param string $text optional
     * @return OpenDocument_ListItem
     * @access public
     */
    public function createListItem($text = '')
    {
