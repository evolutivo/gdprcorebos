...
function sendGridMail($toList,$content,$subject,$from,$campaignid,$type,$crmid,$attachments=array()) {
...
//	$rstplotxt = $adb->query("select templateonlytext from vtiger_businessactions where businessactionsid=$crmid");
