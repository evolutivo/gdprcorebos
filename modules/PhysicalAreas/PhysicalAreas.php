...
class PhysicalAreas extends CRMEntity {
	public $db;
	public $log;

	public $table_name = 'vtiger_physicalareas';
	public $table_index= 'physicalareasid';
	 ...
	 */
	public $customFieldTable = array('vtiger_physicalareascf', 'physicalareasid');
	 ...
	 */
	public $tab_name = array('vtiger_crmentity', 'vtiger_physicalareas', 'vtiger_physicalareascf');
	...
	public $list_link_field = 'physicalareasname';
	...
	public $popup_fields = array('physicalareasname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	public $sortby_fields = array();

	// For Alphabetical search
	public $def_basicsearch_col = 'physicalareasname';

	// Column value to use on detail view record text display
	public $def_detailview_recname = 'physicalareasname';

	// Required Information for enabling Import feature
	public $required_fields = array('physicalareasname'=>1);
