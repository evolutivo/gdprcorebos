...
class DocSettings extends CRMEntity {
	 ...
	 */
	public $customFieldTable = array('vtiger_docsettingscf', 'docsettingsid');
	 ...
	 */
	public $tab_name = array('vtiger_crmentity', 'vtiger_docsettings', 'vtiger_docsettingscf');
	...
	public $list_fields = array(
		...
		'DocSettings Name'=> array('docsettings'=> 'docsettingsname'),
		'Assigned To' => array('crmentity' => 'smownerid')
	);
	public $list_fields_name = array(
		/* Format: Field Label => fieldname */
		'DocSettings Name'=> 'docsettingsname',
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view from list view (Fieldname)
	public $list_link_field = 'docsettingsname';
	...
	public $popup_fields = array('docsettingsname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	public $sortby_fields = array();

	// For Alphabetical search
	public $def_basicsearch_col = 'docsettingsname';
	...
	public $default_order_by = 'docsettingsname';
	public $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	public $mandatory_fields = array('createdtime', 'modifiedtime', 'docsettingsname');
