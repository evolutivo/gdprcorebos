...
alt="{'LBL_SELECT'|@getTranslatedString}" title="{'LBL_SELECT'|@getTranslatedString}" onclick='return vtlib_open_popup_window("","gendoctemplate","evvtgendoc","");' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
