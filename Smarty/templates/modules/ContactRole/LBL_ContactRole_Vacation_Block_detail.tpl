...
<tr style="height:50px" class="createview_field_row">
    ...
    <td id="td_contactrole_vacations_desc" width="20%" class="dvtCellLabel" align="right"><font color="red"></font>{$MOD.LBL_ContactRole_Dates} {$module.name|@getTranslatedString}</td>
